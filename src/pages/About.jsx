            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div>
                <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  warehousing, distribution, e-commerce fulfillment, storage,
                  and transportation services. Our vision for excellence is
                  driven by our S.M.A.R.T Way.
                </p>
                <p className="text-gray-700 leading-relaxed mb-6">
                  SPDC Plc was founded in 1966 as Associated Press Limited
                  ("AP"), an American-based independent new organization, and
                  commenced business immediately, after over 20 years of
                  successful business operation, in 1987 SMURFIT now
                  SMURFITKappa is a FTSE 100 company and one of the leading
                  providers of paper-based packaging, acquired the company and
                  the name was changed to Smurfit Print Nigeria Limited and was
                  subsequently listed on the Nigerian Stock Exchange now NGX.
                </p>
                <p className="text-gray-700 leading-relaxed mb-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div>
                <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  delivering the best value for our clients and offering
                  superior returns to our shareholders dynamically and
                  sustainably.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              ...
              <div className="bg-gray-100 p-6 rounded-lg hover:shadow-lg transition-all duration-300">
                <div className="text-center">
                  ...
                  <p className="text-gray-700">
                    We communicate with clarity and precision in all our
                    dealings.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gray-100 p-6 rounded-lg hover:shadow-lg transition-all duration-300">
                <div className="text-center">
                  ...
                  <p className="text-gray-700">
                    We embrace innovative thinking and transformative
                    approaches.
                  </p>
                </div>
              </div>
          ...
          <section ref={ourTeamRef} className="mb-24">
            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  He is currently the CEO of SMARTS Products Plc, prior to
                  joining SMARTS Products, he was the Group Head of Business
                  Development at Afrinvest (West Africa) Limited. He was also a
                  Senior Associate at Afrinvest Capital Limited, leading deal
                  origination, execution and sales. Before joining Afrinvest, he
                  was an Assistant Manager and Corporate Finance Team lead at
                  AT&A Capital Limited. He was previously the Investment Banking
                  Team Lead at MorganCapital’s Investment Banking Group and
                  Chief Risk Officer at MorganCapital Securities Limited, where
                  he anchored fundraising activities of the Investment Banking
                  group and spearheaded enterprise risk management and reduction
                  in business risks.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  ...
                  sector organizations in accessing funds from the Capital
                  Market. He has very strong contacts with many African-focused
                  & emerging markets investors/fund managers
                </p>
              </div>
            </div>
          </section>
